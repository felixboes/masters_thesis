...
\begin{tikzpicture}[x=.7cm, y=.4cm, line width=.5pt]
    ...
    \draw[line width=1.2pt] (-4, 6) -- (5, 6);
    \draw[line width=1.2pt] (-4, 8) -- (5, 8);
    
    \draw[-latex, color= blue, line width=1.5pt] (-2.5, 2) -- (-2.5,3.8);
    \draw[color= blue, line width=1.5pt] (-2.5, 2.5) -- (-2.5,4);
    \draw[-latex, color= blue, line width=1.5pt] (-2.5, 6) -- (-2.5,7.8);
    \draw[color= blue, line width=1.5pt] (-2.5, 6.5) -- (-2.5,8);
    % draw slits
    \draw[line width=1.2pt] (-4, 6.5) to (-2.5, 6.5);
    \draw[line width=1.2pt] (-4, 2.5) -- (-2.5, 2.5);
    \filldraw (-2.5, 6.5) circle (2pt);
