...
With {\bfseries libhomology} we provide an expandable framework for all kinds of homology computations.
...
The template class \progclass{ChainComplex} is the core of {\bfseries libhomology}.
