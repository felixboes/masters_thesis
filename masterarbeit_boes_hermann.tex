...
\date{12th September 2014}              % Datum der Abgabe der Arbeit.
...
% Erklärung zur Form
\chapter*{Zurechnung der Teile zu den Autoren}
    Die vorliegende Masterarbeit ist eine Gruppenarbeit im Sinne der Masterprüfungsordnung.
    Diese verlangt, dass klar zu erkennen ist, welche Abschnitte welchem Prüfling anzurechnen sind.
    Wir kennzeichnen die Teile der Arbeit im Inhaltsverzeichnis sowie auch zu Beginn der Teile mit [B] bzw.\ [H] gemäß ihrer Zurechnung zu Felix Jonathan Boes bzw.\ zu Anna Hermann.
    Teile, die gemeinsam geschrieben wurden oder weiter unterteilt sind, werden mit [B,H] markiert. 
