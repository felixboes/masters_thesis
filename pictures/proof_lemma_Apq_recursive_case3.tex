...
\begin{document}
\begin{tikzpicture}[xscale=.4, yscale=.4, line width=1pt]
    % Linien.
    ...
    \fill[pattern=north east lines, pattern color=Plum] (1 - .25, 3 - .25) -- (10 + .25, 3 - .25) -- (10 + .25, 3 +  .5) -- (1 - .25, 3 +  .5) -- cycle;
    \fill[pattern=north east lines, pattern color=Plum] (1 - .25, 5 -  .5) -- (10 + .25, 5 -  .5) -- (10 + .25, 5 + .25) -- (1 - .25, 5 + .25) -- cycle;
    \fill[pattern=north east lines, pattern color=Plum] (1 - .25, 7 - .25) -- (10 + .25, 7 - .25) -- (10 + .25, 9 + .25) -- (1 - .25, 9 + .25) -- cycle;
    
    % Berandung der grünen Blöcke.
    \draw[color=Plum, thick] (1 - .25, 1 + .25) -- (1 - .25, 0 -.25) -- ( 10 + .25, 0 - .25) -- (10 + .25, 1 + .25);
    \draw[color=Plum, thick] (1 - .25, 3 - .25) -- (1 - .25, 3 +  .5) -- (10 + .25, 3 +  .5) -- (10 + .25, 3 - .25);
    \draw[color=Plum, thick] (1 - .25, 5 + .25) -- (1 - .25, 5 -  .5) -- (10 + .25, 5 -  .5) -- (10 + .25, 5 + .25);
    \draw[color=Plum, thick] (1 - .25, 7 -.25) -- (1 - .25, 9 + .25) -- (10 + .25, 9 + .25) -- ( 10 + .25, 7 - .25);
