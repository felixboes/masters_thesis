\subsection{The Tool \progname{compute\_css} [B,H]}
...
\subsubsection{Implementation Details [B,H]}
...
{\bf [B]} The main task is determining the first and second page of the cluster spectral sequence.
